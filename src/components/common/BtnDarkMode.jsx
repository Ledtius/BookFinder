  ...
  return (
    <>
      <div className="relative w-fit bg-red-500">
        <button className="menu-btn transition-all duration-300 ease-in-out relative">
          sss
        </button>
        <nav className="flex justify-center border-1 border-gray-400 p-5 shadow-lg bg-white dark:bg-neutral-900 absolute right-0">
          <ul className="flex items-center flex-col gap-4 w-full">
